...
int sc_main(int argc, char *argv[])
{
  ...
  // We have 2 clk domain, declartion of sc_clock
  ...
  // Declaration of a senders modules, we have 0,1,2,3. Meaning 4 senders
  sender sender0("SENDER0");
  // hooking up signals to ports by name for port connections
